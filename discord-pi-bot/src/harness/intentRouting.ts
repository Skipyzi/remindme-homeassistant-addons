...
const memoryTerms =
	/\b(remember|memory|memories|notes?|vault|recall|forget|jot|save (?:this|that|it)|keep track|what did (?:i|we)|last (?:time|week|month))\b/i;
