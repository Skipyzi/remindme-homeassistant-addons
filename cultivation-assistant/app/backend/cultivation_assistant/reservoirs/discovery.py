...
from cultivation_assistant.home_assistant.state_cache import EntityState, EntityStateCache
from cultivation_assistant.reservoirs.roles import get_role_definition
from cultivation_assistant.reservoirs.schemas import EntityCandidate
from cultivation_assistant.reservoirs.units import Compatibility, classify_unit
...
class EntityDiscoveryService:
    """Suggest cached entities that can safely satisfy a reservoir role."""
